...
public class SPLSyntaxHighlighter extends SyntaxHighlighterBase {
    ...
    public static final TextAttributesKey LPARENTHESES = createTextAttributesKey("LPAREN", DefaultLanguageHighlighterColors.PARENTHESES);
    public static final TextAttributesKey RPARENTHESES = createTextAttributesKey("RPAREN", DefaultLanguageHighlighterColors.PARENTHESES);
