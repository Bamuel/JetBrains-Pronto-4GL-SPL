...
public class ENQFileAction extends AnAction {
    ...
    public void actionPerformed(@NotNull AnActionEvent e) {
        ...
        if (selectedDirectory != null) {
            ...
            String fileName = Messages.showInputDialog(project, "Enter new file name:", "New ENQ File", Messages.getQuestionIcon());

            if (fileName != null && !fileName.trim().isEmpty()) {
                // Trim whitespace and check for ".enq" extension
                String trimmedFileName = fileName.trim();
                if (!trimmedFileName.toLowerCase().endsWith(".enq")) {
                    trimmedFileName += ".enq"; // Append .enq if not already present
                }
                ...
                ApplicationManager.getApplication().runWriteAction(() -> {
                    try {
                        // Use enqFileAction.this to refer to the outer class
