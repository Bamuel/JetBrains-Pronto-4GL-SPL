...
public class ERRSyntaxHighlighter extends SyntaxHighlighterBase {
    ...
    public static final TextAttributesKey ERROR = TextAttributesKey.createTextAttributesKey("LOG_ERROR", DefaultLanguageHighlighterColors.KEYWORD);

    public static final TextAttributesKey WARNING = TextAttributesKey.createTextAttributesKey("LOG_WARNING", DefaultLanguageHighlighterColors.KEYWORD);

    public static final TextAttributesKey INFO = TextAttributesKey.createTextAttributesKey("LOG_INFO", DefaultLanguageHighlighterColors.KEYWORD);
